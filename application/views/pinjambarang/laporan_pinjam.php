            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a href="cetak" target="_blank"><button class="btn btn-info" style="font-size: 16px; "><i class="fa-sharp fa-solid fa-print" style="font-size: 20px; "></i><span style="padding-left: 15px;">Cetak Data</span> </button></a>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                <?php if ($this->session->userdata('level') == 'Petugas') { ?>
                                                    ...
                                                    <a href="<?= base_url('transaksi/detailpinjam/' . $isi['pinjam_id'] . '?pinjam=yes'); ?>" target="_blank" class="btn btn-primary btn-sm" title="detail pinjam"><i class="fa fa-eye"></i></button></a>
											...
											<i class="fa fa-trash"></i></a> -->
                                                <?php } else { ?>
                                                    <a href="<?= base_url('transaksi/detailpinjam/' . $isi['pinjam_id']); ?>" target="_blank" class="btn btn-primary btn-sm" title="detail pinjam">
