											...
											<tr>
												...
												<td>
													<div class="input-group">
														<input type="text" class="form-control" autocomplete="off" name="buku_id" id="buku-search" placeholder="Contoh ID Buku : BK001" type="text" value="" required>
									...
									<div class="col-sm-7">
										...
										<tr style="background:yellowgreen">
											...
											<tr>
												...
												<td>:</td>
												<td>
													<input type="number" required placeholder="Lama Pinjam Contoh : 2 Hari (2)" value="7" name="lama" class="form-control"  readonly>
												</td>
											</tr>
											<tr>
												<td>Jumlah Pinjam</td>
												<td>:</td>
												<td>
													<input type="number" required placeholder="Jumlah Yang mau di pinjam : 1 " value="1"  name="jml_pinjam" class="form-control" readonly>
												</td>
											</tr>
										...
										<table class="table table-striped">
											...
											<tr>
												...
												<td>
													...
													<input type="text" class="form-control" required autocomplete="off" name="anggota_id" value="<?= $d->anggota_id; ?>" readonly placeholder="Contoh ID Anggota : AG001">
