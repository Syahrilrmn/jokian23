                    ...
                    <div class="box-body">
                        ...
                        <div class="pull-right">
                            <a data-toggle="modal" data-target="#TableDenda" class="btn btn-primary btn-md" style="margin-left:1pc;">
                                <i class="fa fa-sign-in"></i> Buat Catatan</a>
    ...
    <div class="modal-dialog" style="width:70%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"> Detail Buku Hilang</h4>
            </div>
            <div id="modal_body" class="modal-body fileSelection1">
                <table class="table table-striped">
                    ...
                    <tr>
                        <td style="color: red;">Perhatian</td>
                        <td>:</td>
                        <td>
                            <span style="color:red">pergantian buku sesuai banyak nya halaman buku</span>
                        </td>
                        <!-- <td>
                            <?php
                            $pinjam_id = $pinjam->pinjam_id;
                    ...
                    <!-- <tr>
                        <td>
                            <form action="<?php echo base_url('transaksi/catatan'); ?>" method="post">
                                <div class="form-group">
                                    <label for="summernotehal">Keterangan Lainnya</label>
                                    <textarea class="form-control" name="catatan" id="summernotehal" style="height:120px;"></textarea>
                                </div>
            ...
            <div class="modal-footer">
                <div class="pull-right">
                    <a href="<?= base_url('transaksi/prosespinjam?hilang=' . $pinjam->pinjam_id); ?>">
                        <button class="btn btn-primary"> Proses Buku Hilang</button></a>
