                        ...
                        <form form action="<?php echo base_url('Notifikasi/store'); ?>" method="POST"
                            ...
                            <div class="row g-3">
                                <div class="col-12 ">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="namaPegawai"></textarea>
                                </div>
                                <div class="col-12">
                                    <label for="exampleFormControlTextarea1" class="form-label">Isi Pengumuman</label>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="isiPengumuman"></textarea>
                                </div>
                                <div class="col-12 ">
