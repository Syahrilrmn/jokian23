                    ...
                    <div class="modal fade" id="modalTransaksi" data-bs-backdrop="static" data-bs-keyboard="false"
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($dataTransaksi as $isi): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?= date('d-m-Y H:i:s', strtotime($isi->updated_at)); ?>
                                                    </td>

                                                    <td>
                                                        
                                                            <a
                                                                href="<?= base_url('SolarTransaction/edit/' . $isi->id_transaksi_solar); ?>"><button
                                ...
                                <div class="modal-footer">
                                    <a href="<?php echo base_url("SolarTransaction"); ?>" class="btn btn-primary"><i
                                            class='bx bx-radio-circle'></i>Lihat Semua History Transaksi Anda </a>
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal">Close</button>
                                </div>
